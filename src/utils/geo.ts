export const CC_TO_COUNTRY: Record<string, string> = {
  ...
  TG: "Togo", TO: "Tonga", TT: "Trinidad and Tobago", TN: "Tunisia", TR: "Turkey", TM: "Turkmenistan",
...
export function getCountryName(countryCode?: string | null): string {
  ...
  return CC_TO_COUNTRY[code] || "Unknown";
}
