...
-- Update resolve_link_and_log_click to accept pre-resolved GeoIP data
-- This enables synchronous server-side resolution and ensures accurate logs.
-- =============================================================================
...
BEGIN
  ...
  -- 6. Insert click record with provided GeoIP fields
  ...
  VALUES (
    ...
    COALESCE(p_country_code, 'Unknown'),
